...
/skills - используй для добавления нового навыка в проект
/projects - используй, если хочешь увидеть список всех своих проектов
/delete - используй для удаленик какого-либо из проектов
/update_projects - используй для изменения чего-либо в выбранном проекте
....
...
#Добавление имени, user_id и описания
...
#Реакция на обычное сообщение(не команда)
